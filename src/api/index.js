export default {
  ...
  queryBigCouponsProducts: '/hj/product/queryBigCouponsProducts', // 大额内部券
  ...
  applyMoney: '/hj/user/account/applyMoney', // 提现申请
  ...
  queryList: '/hj/content/feedshome/queryList', // 查询商品信息
  ...
  queryChosenFeedsList: '/hj/revelatrecom/feeds/queryMixChosenHotFeedsList', // 精选
